...
describe('COMPLETE action', () => {
  ...
  it('should reduce the state', () => {
    ...
    expect(get(result, 'values.meta.name')).toBe('Dev')
    ...
    expect(get(result, 'values.packaging')).toBe('zip')
    expect(get(result, 'values.meta.namespace')).toBe('DevNamespace')
    expect(get(result, 'values.dotNetFramework')).toBe('netcoreapp3.1')
