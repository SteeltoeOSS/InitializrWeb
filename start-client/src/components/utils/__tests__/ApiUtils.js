...
describe('getListValues', () => {
  ...
  //   const json = { ...MockClient }
  //   const listsValues = getLists(json)
  //   const listDotNetFrameworkVersions = get(listsValues, 'meta.dotNetFramework')
  //   const mockDotNetFrameworks = get(MockClient, 'dotNetFramework.values')
  //   expect(listDotNetFrameworkVersions.length).toBe(mockDotNetFrameworks.length)
  //   for (let i = 0; i < mockDotNetFrameworks.length; i += 1) {
  //     expect(listDotNetFrameworkVersions[i].key).toBe(mockDotNetFrameworks[i].id)
  //     expect(listDotNetFrameworkVersions[i].text).toBe(mockDotNetFrameworks[i].name)
  //   }
  // })
